<h1><font color=#0d65b1>Python 语言项目构建</font></h1> 

<h2><font color=#0d65b1>使用条件</font></h2> 

<h3><font color=#0d65b1>源码要求</font></h3> 
<ul>
<li><p>编码语言：Python</p></li>
<li><p>编译器：无</p></li>
<li><p>编译脚本：shell 或其他（无构建脚本只提供 Dockerfile）</p></li>
<li><p>Dockerfile：由于 Python 语言项目的编译和部署的特殊性，建议考虑使用 docker build 进行编译。如果使用 docker build 进行编译，则需要提供 Dockerfile。
</p></li>
</ul>
